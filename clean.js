...
const categorias = [
    {id:1, nombre: "KA"},
    {id:2, nombre: "RANGER"},
    {id:3, nombre: "ECOSPORT"},
    {id:4, nombre: "FIESTA"},
    {id:5, nombre: "TERRITORY"},
    {id:5, nombre: "ACCESORIOS VARIOS"}
   ...
   {id:05, nombre: "Alarma volumétrica", precio: 12100, categoria: 1, stock: 10 },
   
   
   {id:06, nombre: "polarizado", precio: 8200, categoria: 5, stock: 10 },
   {id:07, nombre: "tratamiento de teflón", precio: 9800, categoria: 5, stock: 10 },
   {id:08, nombre: "Polarizado antivandálico", precio: 12.500, categoria: 5, stock: 10 },
   
   
   {id:09, nombre: "Lona marítima", precio: 35500, categoria: 2, stock: 10 },
   {id:10, nombre: "Gancho de remolque + instalación eléctrica", precio: 62500, categoria: 2, stock: 10 },
   ...
   {id:17, nombre: "Tuercas de seguridad", precio: 5900, categoria: 5, stock: 10 },
   ...
   {id:22, nombre: "Barras portaequipaje", precio: 15300, categoria: 3, stock: 0 }
   
   ]
   
   localStorage.setItem("MIS_PRODUCTOS", JSON.stringify (productos));
   
   let misdatos = JSON.parse(localStorage.getItem("MIS_PRODUCTOS"));
